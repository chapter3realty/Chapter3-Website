...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What comes out of the rent on a Myrtle Beach rental?", html: (bg) =>
      ...
      h.cta("Have us help find a new rental.", "Tell us the area and the budget. We run the rent, each cost and the association documents before you write the offer.", "Have us run the numbers", RTN, bg) },
