...
module.exports = {
  ...
  sections: [
    ...
    { h2: "How do you put insurance into the offer?", html: (bg) =>
      ...
      h.cta("Buying a rental on the coast?", "Tell us the address and how you will use it. We price the insurance and the tax before you offer, and our analyzer carries both in the cash flow.", "Let us make it simple", "/contact/", bg) },
  ],
