 ...
 * the court's FAQ, the Johnson opinion, federal pages). The next sale date is
 * not printed: it changes monthly. Built by tools/mkpage.js. */
...
module.exports = {
  ...
  description: "How a foreclosure purchase works in Horry County: the monthly master-in-equity sale, the certified-funds deposit, the 30-day bidding period, and bank-owned listings.",
  ogTitle: "How to buy a foreclosure in Horry County: the sale, the deed and REO",
  crumb: "Foreclosures",
  ...
  sections: [
    { h2: "What is a foreclosure sale in Horry County?", html:
      ...
      h.p("There are two ways to buy. You bid at the sale, or you buy the house from the lender after the lender wins the bid and lists it. The second kind is a bank-owned listing, called REO. This page covers both, and the county's separate tax sale.") +
    ...
    { h2: "What does the master's deed carry?", html:
      ...
      h.p(`The court has no keys, no knowledge of the condition and no access to give you. ${h.ext(BIDDER, "The county advises")} an attorney's certification of title, based on a title search, before you bid. On a master-in-equity deed ${h.ext(DRF, "the buyer pays the deed recording fee")}, $1.85 for each $500 of value. On an ordinary sale the seller pays it.`) +
    ...
    { h2: "How does a bank-owned listing work?", html: (bg) =>
      h.p("When the lender is the high bidder, the house becomes the lender's real estate owned, REO. The lender lists it on the MLS and sells it through an ordinary contract and closing. Ordinary financing works when the condition allows.") +
    ...
    { h2: "What about the county tax sale?", html:
      ...
      h.p(`Payment is cash or certified funds at the close of the sale. Then you wait. ${h.ext(T1251, "The owner, a grantee or a mortgage holder has 12 months")} to redeem by paying the taxes and costs. During those 12 months you have no ownership rights, cannot enter the property and cannot contact the owner. After a second 12 months the tax deed is incontestable.`) +
      h.p(`A tax sale bid is a 12-month wait for either the property or the money back with interest. It is not a purchase you can plan a rental around. ${h.a("/buyers/property-taxes/", "How the tax bill is calculated")}.`) },
    { h2: "How do you check a sale property before you bid?", html:
      ...
      h.p(`Drive by. You cannot go in. Price the repairs from the outside and from the last listing photos, and hold back for what you cannot see. Then run the rent against the bid, the repairs, the back taxes and the recording fee. ${h.a("/invest/where-to-buy/", "Which areas fit which strategy")}.`) },
  ],
  ...
  keywords: "Horry County foreclosure sale, master in equity sale Horry County, buying a foreclosure in Myrtle Beach, Horry County tax sale redemption, REO homes Myrtle Beach",
  about: "Buying a foreclosure at the Horry County master-in-equity sale or as a bank-owned listing",
};
