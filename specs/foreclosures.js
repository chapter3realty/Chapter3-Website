...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What is the 30-day upset bid period?", html: (bg) =>
      ...
      h.cta("Watching a property on the sale list?", "Send the address. We pull the judgment and the notice of sale and analyze the property for cash flow and repair costs.", "Send the address", RTN, bg) },
    { h2: "What is the master's deed, and what does it carry?", html:
      h.p(`The master-in-equity is the Horry County judge who runs the foreclosure sale. The master's deed is the deed that judge signs to the winning bidder after the sale. It carries less than the deed in an ordinary sale. ${h.ext(BIDDER, "The master's deed is not a warranty deed")}. ${h.ext(T15, "It passes the rights the court adjudged to be sold")}, and nothing more. The liens of everyone named in the case end at the sale. A lien held by someone who was not in the case survives, including a prior mortgage that was not foreclosed.`) +
      ...
      h.p(`${h.ext(MIEFAQ, "The court's own guide")} tells the owner they may stay until the home is sold and the deed issues. The foreclosure chapter of the state code contains no redemption period after that. The tax sale is different. It has a 12-month redemption period.`) },
    ...
    { h2: "How do you pay for a courthouse purchase?", html:
      h.p(`${h.ext(BIDDER, "The county's terms")} are certified funds for the deposit by noon the next day and full payment within 30 days. Neither county document mentions financing or a contingency. The judgment states the compliance date, and the deposit is forfeited if you miss it.`) +
      h.p("Decide how you will pay before you register. A loan that needs an appraisal, an inspection or a title commitment has to close inside the compliance period, on a deed with no warranty. Ask the lender before the sale whether it will do that, and whether it will lend against the property once the deed is recorded.") +
    ...
    { h2: "How does a bank-owned listing work?", html: (bg) =>
      ...
      h.cta("Want bank-owned listings?", "Tell us the area and the budget. We send the bank-owned listings with the rent and the repair estimate for each one.", "Ask about REO listings", "/contact/", bg) },
    { h2: "What about past-due HOA fees on a foreclosed condo?", html:
      h.p("In an ordinary sale the association's lien for past-due assessments is paid from the seller's proceeds at closing. At a foreclosure sale there may be no proceeds. In Chapter3's experience the association then asks the new owner for the balance, or waives it. We get the association's statement before closing, so the balance is in the numbers and not a surprise after the deed.") +
      h.p("The balance can end the deal. Our example: a flip carrying $7,000 of back assessments, with no margin left after them, is a property we tell you not to bid on.") },
    { h2: "What about the county tax sale?", html:
      ...
      h.p(`Our summary: tax sales have the largest possible gain and are the hardest to complete, because the law is written to let the owner keep the house. Either you own a house for the taxes and costs, or you get the bid back with interest. ${h.a("/buyers/property-taxes/", "How the tax bill is calculated")}.`) },
