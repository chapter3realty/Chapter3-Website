 ...
 * the court's FAQ, the Johnson opinion, federal pages). Brokerage facts and
 * the tax-sale story from research/invest-next/owner-answers-batch3.md
 * (answers 26 to 32). The next sale date is not printed: it changes monthly.
...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What about the county tax sale?", html:
      ...
      h.p(`Devin Day's summary: tax sales have the most upside and are the hardest to complete, because the law is written to let the owner keep the house. Either you own a house for the taxes and costs, or you get the bid back with interest. ${h.a("/buyers/property-taxes/", "How the tax bill is calculated")}.`) },
    { h2: "How do you check a sale property before you bid?", html:
      ...
      h.p(`Drive by. You cannot go in. Price the repairs from the outside and from the last listing photos, and hold back for what you cannot see. Then run the rent against the bid, the repairs, the back taxes, the association balance and the recording fee. ${h.a("/invest/where-to-buy/", "Which areas fit which strategy")}.`) },
  ],
