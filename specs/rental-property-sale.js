...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What tax comes due on the gain?", html: (bg) =>
      ...
      h.p(`A 1031 exchange defers both layers. ${h.ext(I8824, "You identify the replacement within 45 days")} of the sale and receive it within 180 days, or by your return due date if that comes first. The identification clock starts on closing day, so line up the replacement before you list. ${h.a("/invest/strategies/1031-exchange/", "How we run a 1031 here")}. ${h.a("/invest/cost-segregation/", "What recapture costs after a cost segregation study")}.`) +
      h.cta("Want the net figured before you list?", "Send the address, the lease and the depreciation you have taken. We show what closing costs, withholding and the two tax layers leave you, and what an exchange changes.", "Have us price the rental", HV, bg) },
    { h2: "How do you price and market a rental?", html:
      ...
      h.p("Three ways to run it. Sell now with the tenant in place, to investors. Sell at lease end, to everyone. The third way is a written buyout that pays the tenant to leave early, which opens the wider pool sooner. We list the rent, the lease dates and the deposit in the listing package so an investor can run the numbers from the listing.") +
      h.p(`For a condo, the buyer can ask the association for a statement of what you owe, and unpaid assessments are paid from the price at closing. Clear them first. ${h.a("/sell/net-proceeds/", "What you walk away with, line by line")}.`) },
  ],
