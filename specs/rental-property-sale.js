...
module.exports = {
  ...
  sections: [
    ...
    { h2: "Who can buy a house with a tenant in it?", html:
      ...
      h.p(`Investors look at two things. They pay more for a house in good condition. A house the tenant kept up sells to a turnkey investor at full price. A damaged house sells to a repair-and-rent investor at a discount, so the damage costs you the repair and the discount. They also check that the rent covers the costs. The investor pays today's price and today's taxes, so the rent covers less of the cost than it did for you. A house in an appreciating area still sells with modest cash flow. We have investors who buy exactly that. ${h.a("/buyers/property-taxes/", "How the sale resets the tax value")}.`) +
