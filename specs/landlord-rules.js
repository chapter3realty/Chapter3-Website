 ...
 * forms, the fee schedule, county pages, federal pages). The page states the
 * legal minimums only; observed court times are an owner question. Built by
 * tools/mkpage.js. */
...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What must you give the tenant at move-in?", html:
      ...
      h.p("A late fee is a lease term, not a statute. The law counts late charges as rent and sets no cap. Write the amount and the grace period into the lease. The only limits are the ban on making the tenant waive rights and the rule against unconscionable terms.") },
    ...
    { h2: "How does an eviction work in Horry County?", html: (bg) =>
      h.p("The law sets the minimum times. The calendar belongs to the court and the sheriff. There are four steps.") +
    ...
    { h2: "How do you screen an applicant?", html:
      ...
      h.p(`Keep the application, the report and the notice for every applicant, accepted or not. ${h.a("/invest/student-rentals/", "A student house adds an occupancy cap")}. ${h.a("/invest/mid-term-rentals/", "A furnished mid-term rental screens a traveling professional")}.`) },
  ],
  ...
  faq: [
    ...
    { q: "How long does an eviction take in Horry County?", a: "The law sets the minimums. A tenant served in person has ten days to answer, and 20 days if the rule was posted and mailed. After a hearing or a default, the writ issues within five days, and the sheriff gives 24 hours. Court scheduling adds to that." },
  ...
  keywords: "South Carolina landlord tenant law, Horry County eviction process, Myrtle Beach landlord rules, security deposit return South Carolina 30 days, magistrate court ejectment fee",
