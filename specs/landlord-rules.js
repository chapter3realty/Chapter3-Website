...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What must a landlord give a new tenant in writing?", html:
      h.p(`Three documents, at or before move-in. The first is ${h.ext(LTA, "the name and address of the owner")}, or of the person who acts for the owner. Keep it current. The duty passes to whoever owns the property next.`) +
      ...
      h.p(`The third is a receipt for the deposit, if you take one. ${h.ext(LTA, "The deposit rule")} has no maximum, no interest requirement and no separate-account requirement. An owner of more than four adjoining units who applies different deposit standards to different tenants must post the standards or hand each applicant a copy.`) +
