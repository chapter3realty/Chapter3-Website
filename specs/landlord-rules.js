 ...
 * (answers 14, 16, 17, 18, rounds 2 and 3). Owner rule 2026-09-06: the
 * owner's name is never written on this page, and nothing "sets" anything.
...
module.exports = {
  ...
  sections: [
    { h2: "Who is a landlord under South Carolina law?", html:
      h.p(`${h.ext(LTA, "South Carolina's residential landlord and tenant law")} covers every house, condo and apartment rented as a home. It applies whoever owns the property and wherever the owner lives. It lists duties for the landlord and for the tenant. A lease cannot make the tenant waive them.`) +
    ...
    { h2: "What must a landlord give a new tenant in writing?", html:
      h.p(`Three documents, at or before move-in. Give the tenant ${h.ext(LTA, "the name and address of the owner")}, or of the person who acts for the owner. Keep it current. The duty passes to whoever owns the property next.`) +
      h.p(`Give the tenant the lease, with the state's rent notice in bold, conspicuous type. The law lets that clause serve as the only notice of nonpayment for the whole tenancy. It reads: "If you do not pay your rent within five days of the due date, the landlord can start to have you evicted. You will get no other notice as long as you live in this rental unit."`) +
      h.p(`Give the tenant a receipt for the deposit, if you take one. ${h.ext(LTA, "The deposit rule")} has no maximum, no interest requirement and no separate-account requirement. An owner of more than four adjoining units who applies different deposit standards to different tenants must post the standards or hand each applicant a copy.`) +
      h.p("A late fee is a lease term, not a statute. The law counts late charges as rent and has no cap. Write the amount and the grace period into the lease. The only limits are the ban on making the tenant waive rights and the rule against unconscionable terms. Which charge and which grace period fit your unit is case by case. We go through the lease with you, clause by clause, before the first tenant signs.") },
    { h2: "What does the buyer need to give the existing tenants?", html:
      h.p(`A buyer who closes on a rented house becomes the landlord at closing. Within a reasonable time, give each tenant, in writing, ${h.ext(LTA, "the name and address of the new owner")} or of the person who acts for the owner. Keep it current. That notice also ends the seller's liability under the lease for anything after it.`) +
      h.p(`The deposit comes with the sale. The seller stays liable for it until it is transferred to you and the tenant is told in writing. Ask for both at closing: the deposit as a credit on the settlement statement, and a notice to the tenant that names you as the holder. ${h.a("/sell/rental-property/", "What the seller must do")}.`) +
      h.p("The lease itself does not change. Read it for the five-day rent clause in bold. If the clause is missing, send one written notice of nonpayment at the first late payment, and add the clause at renewal.") },
    ...
    { h2: "How do you screen an applicant?", html:
      h.p(`${h.ext(HUD, "Fair housing law")} bars any decision based on race, color, national origin, religion, sex, familial status or disability. That covers refusing to rent, applying different terms, and saying a unit is unavailable when it is not. Write one screening standard and apply it to every applicant.`) +
      ...
      h.p(`Keep the application, the report and the notice for every applicant, accepted or not. We work with screening companies we recommend once you are a client, and the notice rules apply whichever one you use. A tenant with a housing voucher is screened the same way, and ${h.a("/invest/section-8-rentals/", "the housing authority pays its share directly")}. ${h.a("/invest/student-rentals/", "A student house adds an occupancy cap")}. ${h.a("/invest/mid-term-rentals/", "A furnished mid-term rental screens a traveling professional")}.`) },
  ],
  ...
  faq: [
    ...
    { q: "What does the buyer of a rented house have to give the tenants?", a: "The name and address of the new owner, or of the person acting for the owner, in writing within a reasonable time. Take the deposit as a credit at closing and have the tenant told in writing that you hold it." },
    ...
    { q: "How long does an eviction take in Horry County?", a: "The law states the minimums. A tenant served in person has ten days to answer, and 20 days if the rule was posted and mailed. After a hearing or a default, the writ issues within five days, and the sheriff gives 24 hours. In Chapter3's files the process takes up to three weeks, and a few days for a strong case." },
  ...
  keywords: "South Carolina landlord tenant law, Horry County eviction process, how long does an eviction take in Horry County, Myrtle Beach landlord rules, security deposit return South Carolina 30 days, magistrate court ejectment fee, buying a rental with tenants what to give the tenant",
