...
module.exports = {
  ...
  sections: [
    ...
    { h2: "How many students can live in one house?", html: (bg) =>
      ...
      h.p(`Federal law applies as well. ${h.ext(HUD, "The Fair Housing Act")} protects race, color, national origin, religion, sex, familial status and disability. Student status is not protected, but a rule aimed at students that keeps out families with children breaks the law. ${h.ext(FR98, "Two people per bedroom")} is the federal benchmark for a reasonable occupancy policy for families.`) +
