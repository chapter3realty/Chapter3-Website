...
module.exports = {
  ...
  sections: [
    ...
    { h2: "How many students can live in one house?", html: (bg) =>
      ...
      h.p("The parking rule has a plain solution: a driveway that holds one car per tenant, and a lease that limits the tenants to that many cars. We measure the driveway before you offer.") +
    ...
    { h2: "Do parents buy a house near campus?", html:
      h.p(`Yes, and not as a rental. In Chapter3's files a parent buys a house near campus and moves the family into it, so the student lives at home and close to class. The house is the family's legal residence. It is taxed at the 4 percent rate and financed as a primary residence. ${h.a("/buyers/property-taxes/", "How Horry County property tax is calculated")}.`) +
      h.p("The other pattern is simpler. The student rents, and about three in four times a parent co-signs the lease.") +
      h.p(`A first- or second-year student can live in that house. ${h.ext(POLICY, "The university's housing policy")} exempts a student whose permanent address on file is within 50 miles of campus and who lives there with a parent or legal guardian. The exemption is automatic. The student does not apply for it.`) },
  ...
  sources: [
    ...
    { name: "Coastal Carolina University, housing policy STUD-336", href: POLICY },
