 ...
 * research/invest-next/owner-answers-batch3.md (answers 19 to 25, round 2),
 * attributed to Devin Day, NMLS 2721275, without naming the lender. Body copy
 * never names an investor or a rate; the servicing-guide source sits in the
 * sources line only. Built by tools/mkpage.js. */
...
module.exports = {
  ...
  author: "tim",
  shortAnswer: "An LLC is a company you form with the state to own the rental. South Carolina charges $110 to file the articles and requires a registered agent with a street address in the state. It asks for no annual report from an LLC that is not taxed as a corporation. A single-member LLC is ignored for state tax. Deeding a rental you already own into it costs no recording fee and does not reset the property tax value. It does not change your income tax: the rental still goes on your Schedule E. The loan is the constraint. A conventional loan is made to a person, not a company. A DSCR loan closes in the LLC, and the lender requires it. Every investor client we work with holds title in an LLC, a trust or a corporation. The company's debts stay the company's, unless you sign a personal guaranty.",
  sections: [
    ...
    { h2: "How do you move a rental you already own into the LLC?", html: (bg) =>
      ...
      h.p("In Chapter3's closings the closing attorney drafts the deed into the LLC. In Devin Day's experience the county rarely questions that deed unless another part of the transfer is irregular.") +
    ...
    { h2: "Can you get a loan in the LLC's name?", html:
      ...
      h.p("With the servicer's approval you can deed the house to your LLC, and that includes a home you live in. The problem is renting out a house you told the lender you would live in. A loan on a primary residence carries a promise to move in and stay, usually for a year. Deeding that house to an LLC a month after closing and renting it out breaks the promise. That is mortgage fraud. Devin Day's rule: we do not help with it, and we show you the legal version, which pays as well or better. Buy with the loan that matches the plan, or live out the occupancy period, then rent.") },
