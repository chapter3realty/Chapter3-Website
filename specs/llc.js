...
module.exports = {
  ...
  sections: [
    ...
    { h2: "Can you get a loan in the LLC's name?", html:
      ...
      h.p(`Every DSCR program and business-purpose loan a loan officer at our preferred lender works with closes in the name of an LLC or a corporation. The lender requires it. ${h.a("/invest/strategies/dscr-loans/", "How a DSCR loan qualifies on the rent")}. The lender writes its own rules on personal guaranties and on which LLC documents it wants.`) +
