 ...
 * federal due-on-sale list, IRS pages). Body copy never names an investor or
 * a rate; the servicing-guide source sits in the sources line only. Built by
 * tools/mkpage.js. */
...
module.exports = {
  ...
  author: "tim",
  shortAnswer: "An LLC is a company you form with the state to own the rental. South Carolina charges $110 to file the articles and requires a registered agent with a street address in the state. It asks for no annual report from an LLC that is not taxed as a corporation. A single-member LLC is ignored for state tax. Deeding a rental you already own into it costs no recording fee and does not reset the property tax value. It does not change your income tax: the rental still goes on your Schedule E. The loan is the hard part. A conventional loan is made to a person, not a company. A DSCR loan can close in the LLC. The company's debts stay the company's, unless you sign a personal guaranty.",
  sections: [
    { h2: "What is an LLC, and what does it do for a rental owner?", html:
      ...
      h.p("An LLC does not lower your income tax and does not replace insurance. It changes who owns the rental. That changes the deed, the loan, the property tax file and the sale, in the order below.") },
    { h2: "What does it cost to form and keep a South Carolina LLC?", html:
      ...
      h.p(`Run the company as a company. Open a bank account in its name, sign the leases in its name, and keep its money apart from yours. ${h.a("/invest/out-of-state/", "An owner in another state")} still needs a registered agent with a South Carolina street address.`) },
    ...
    { h2: "Can you get a loan in the LLC's name?", html:
      ...
      h.p(`Deeding the house to your LLC after closing raises the due-on-sale question. ${h.ext(DOS, "Federal law lists the transfers")} a lender cannot call the loan for. The list names a lease of three years or less, a transfer to a spouse or child, and a transfer at death. It also names a transfer into a living trust that keeps you as the beneficiary. A transfer to a company is not on it. The servicing rules for many conventional loans allow a transfer to an LLC the borrower controls, for loans the investor bought after mid-2016. The same rules require the deed back to a person before a refinance. Your servicer's rule governs. Ask in writing before you record the deed.`) +
      h.p(`${h.a("/invest/strategies/dscr-loans/", "A DSCR loan")} is a business-purpose loan and can close in the LLC's name. The lender sets its own rules on personal guaranties and on which LLC documents it wants. Devin Day, licensed MLO, NMLS 2721275, reviewed this section.`) },
    { h2: "Can an LLC-owned home get the 4 percent rate?", html:
      h.p(`${h.ext(LEGRES, "The 4 percent legal residence rate")} goes to an owner who lives in the home as their domicile. A rental never qualifies, whoever owns it. ${h.ext(CFRE, "The state supreme court has held")} that a home owned by a single-member LLC qualifies when the member meets every test. The ruling covers a single-member LLC only. ${h.ext(HORRYAPP, "Horry County's application")} asks for the operating agreement of a single-member LLC.`) +
    ...
    { h2: "What do you decide before the contract?", html: (bg) =>
      ...
      h.p(`Tell the insurer who holds title. ${h.ext(DOI, "The state's insurance guide")} makes insuring the building the owner's job, and the owner is now the LLC. Ask the carrier how it writes a landlord policy for an LLC owner before you record the deed.`) +
  ...
  faq: [
    ...
    { q: "Can my LLC get a conventional mortgage?", a: "No. Conventional loans are made to people. A business-purpose loan such as a DSCR loan can close in the LLC name. Deeding a house with a conventional loan to your LLC is a question for the servicer, in writing, before you record." },
  ...
  sources: [
    { name: "SC Code, Title 33, Chapter 44, LLCs", href: LLCACT },
    { name: "Secretary of State, entity forms", href: SOSFORMS },
    { name: "SCDOR, corporate FAQs", href: DORFAQ },
    { name: "SC Code 12-24-40, recording fee exemptions", href: DRFLAW },
    { name: "SCDOR, deed recording fee manual", href: DRFMAN },
    { name: "SC Code 12-37-3150, assessable transfers", href: ATI },
    { name: "CFRE, LLC v. Greenville County Assessor", href: CFRE },
    { name: "12 U.S.C. 1701j-3, due-on-sale", href: DOS },
    { name: "Fannie Mae Servicing Guide D1-4.1-02", href: FNMA },
    { name: "SC Code 12-8-580, nonresident withholding", href: WH },
  ...
  keywords: "buying rental property in an LLC South Carolina, transfer rental to LLC South Carolina deed recording fee, LLC property tax reassessment South Carolina, DSCR loan LLC Myrtle Beach, South Carolina LLC filing fee",
