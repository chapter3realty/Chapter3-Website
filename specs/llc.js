...
module.exports = {
  ...
  sections: [
    ...
    { h2: "Can you get a loan in the LLC's name?", html:
      ...
      h.p(`Every DSCR program and business-purpose loan our licensed loan originator works with closes in the name of an LLC or a corporation. The lender requires it. ${h.a("/invest/strategies/dscr-loans/", "How a DSCR loan qualifies on the rent")}. The lender writes its own rules on personal guaranties and on which LLC documents it wants. Reviewed by Chapter3's licensed mortgage loan originator, NMLS 2721275.`) +
  ...
  faqTitle: "LLC FAQ",
  faq: [
    { q: "Do I need an LLC for a DSCR loan?", a: "Yes. Every DSCR and business-purpose program our licensed loan originator works with closes in the name of an LLC or a corporation, and the lender requires it." },
