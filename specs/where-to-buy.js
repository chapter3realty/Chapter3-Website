...
module.exports = {
  ...
  sections: [
    ...
    { h2: "Where does each strategy fit?", html: (bg) =>
      ...
      h.p(`Monthly, furnished: within a short drive of a hospital. Carolina Forest and Socastee for Grand Strand Medical Center, Murrells Inlet for Tidelands Waccamaw, Conway for Conway Medical Center and the university, Little River for McLeod Health Seacoast. ${h.a("/submarkets/carolina-forest/", "Carolina Forest")}. ${h.a("/submarkets/murrells-inlet/", "Murrells Inlet")}. ${h.a("/submarkets/little-river/", "Little River")}.`) +
