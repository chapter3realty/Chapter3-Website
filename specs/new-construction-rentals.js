 ...
 * same day. Brokerage facts from research/invest-next/owner-answers-batch4.md
 * (rounds 1 and 2); the Little River story is anonymized and names no community
 * or builder (non-negotiable 5). "Rules" is the owner's word for covenants.
...
module.exports = {
  ...
  sections: [
    { h2: "How much new construction is there?", html:
      h.p(`${h.ext(FRED, "Builders were allowed to start 6,898 homes")} in the Myrtle Beach area in 2025. The building runs from Little River and Longs in the north, through Carolina Forest and Conway, to Surfside Beach and Murrells Inlet in the south.`) +
    ...
    { h2: "Can you rent out a new house?", html: (bg) =>
      ...
      h.p(`${h.ext(ACCLAIM, "The county's online records index")} holds the recorded rules and the plats. We pull them for any community before a client signs.`) +
    ...
    { h2: "When does a new community cash flow?", html:
      ...
      h.p(`The cash flow went to the early buyers. Each later buyer paid more for the same rent. By the end of the build-out the numbers no longer worked as a rental. Another buyer in the same community, not our client, bought nine houses, rents none of them, and holds them to sell at about $300,000.`) +
    ...
    { h2: "What else changes when the rental is new?", html: (bg) =>
      h.ul([
        `<strong>The tax.</strong> The county assesses a rental at 6 percent from the first bill. ${h.a("/buyers/property-taxes/", "The bill is about three times the bill for the same house as a legal residence")}.`,
        `<strong>The dues.</strong> Association dues in a new community often rise once the builder hands the association to the owners.`,
        `<strong>The inspection and the warranty.</strong> A new house still needs an inspection. The builder's warranty runs from closing, not from the day a tenant reports a problem.`,
        `<strong>The competition.</strong> A house that rents for the same as forty others on the street rents on price alone.`,
      ]) +
  ...
  keywords: "new construction rental property Myrtle Beach, can you rent out a new construction home, new home community rental restrictions South Carolina, buying new construction as an investment Myrtle Beach, builder incentives investors",
