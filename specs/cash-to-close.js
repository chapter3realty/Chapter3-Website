...
module.exports = {
  ...
  sections: [
    ...
    { h2: "What are lender reserves?", html: (bg) =>
      ...
      h.p(`Own other financed properties and the lender adds a percentage of their balances on top. A DSCR loan has its own reserve rule, set by that lender. ${h.a("/invest/strategies/dscr-loans/", "DSCR loans, explained")}. Devin Day, licensed MLO, NMLS 2721275, reviewed this section.`) +
