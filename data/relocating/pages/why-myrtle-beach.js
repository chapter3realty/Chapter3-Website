...
const faq = [
  { q: 'Why is everyone moving to Myrtle Beach?',
    a: 'The same four reasons, in different orders. A typical home is near $342,000 while the places movers come from average $418,000 to $669,000. South Carolina taxes are among the lowest in the country for a primary home. The coast stays warm into October. There is enough growth that work and new construction keep up. The IRS counted about 15,000 households moving into Horry County in a single year.' },
  { q: 'Is Myrtle Beach growing that fast?',
    a: 'Yes. The Census Bureau ranked this metro among the fastest growing in the country in its March 2026 release. Employment here grew 9.1 percent from 2019 to 2025 against 5.1 percent nationally. The households arriving reported about 2.5 times the income of the households leaving on the IRS migration file.' },
