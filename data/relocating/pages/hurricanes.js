...
const faq = [
  ...
  { q: 'Do streets flood in Myrtle Beach when it rains?',
    a: 'During hard rain some streets hold a few inches of water, and the main roads usually drain within hours of the rain stopping. Myrtle Beach and North Myrtle Beach have spent tens of millions on deepwater ocean outfalls that carry street runoff offshore. The exceptions: the lowest streets near the beach when a high tide blocks the drains, and river neighborhoods, where flooding can last days.' },
  { q: 'What is a king tide in Myrtle Beach?',
    a: 'The informal name for the highest tides of the year, on predictable dates around fall full moons. A few low streets flood with no storm at all, most visibly on Pawleys Island, where the causeways have been closed at peak tide and the town is funding a drainage plan. If you are buying on a low street, check the tide calendar and visit at high tide.' },
];
...
<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">After the rain</p><h2 style="${S.h2}">Streets here drain fast, and there is a reason</h2><p style="${S.p}">Devin, who wrote this page, remembers noticing it during Tropical Storm Debby: days of rain, a few inches of water standing on some streets, driving slow but possible, and then the main roads dry almost as soon as the rain stopped. He moved here from Ohio and expected the water to sit. On the main roads, it did not.</p><p style="${S.p}">Part of the reason is built and paid for. Myrtle Beach has spent close to $75 million on four deepwater ocean outfalls, large underground pipes that collect street runoff and carry it more than 1,000 feet offshore, past the breakers, instead of letting it stand in town or pour across the sand. North Myrtle Beach has built six of its own since 2002 and states the purpose plainly: better inland drainage keeps streets and properties dry, and moving the discharge offshore keeps bacteria out of the surf where people swim. More outfalls are planned in both cities.</p><p style="${S.pLast}">Two exceptions decide where to look harder. When heavy rain lands on a very high tide, the drains have nowhere to send the water for a few hours, and the lowest streets in places like Cherry Grove and Garden City hold water until the tide drops. And river flooding is the opposite of street flooding: near the Waccamaw and the Intracoastal, water rises over days and stays, which is the section above this one. Fast-draining streets are a beach-town fact, not a county-wide one.</p></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">No storm required</p><h2 style="${S.h2}">King tides flood a few low streets on a schedule</h2><p style="${S.p}">A king tide is the informal name for the highest tides of the year. They arrive on predictable dates, mostly around fall full moons, with no storm attached. On those days salt water can come up through the storm drains on the lowest streets until the tide turns.</p><p style="${S.p}">Pawleys Island is the local example. On the biggest tides the island&#39;s low streets flood, the causeways have been closed at the peak until the water dropped, and the town says so itself: officials call flooding their first public safety issue, and the island is funding a drainage and flood plan. People who live there check the dates and plan around them. If you are shopping on Pawleys, the tide calendar comes with the island; ask us and we will time a showing to a high tide so you see the street at its worst before you offer.</p><p style="${S.pLast}">Cherry Grove and the lowest streets of Garden City see the same tides. The check costs nothing: look up the elevation of the street, not just the house, and see it once at a high tide before you commit.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">From our team</p><h2 style="${S.h2}">What we actually do when a warning goes up</h2><p style="${S.p}">For a tropical storm or a low-end hurricane, our team stays home and waits it out. Many houses here have window protectors that fold down over the glass in a few minutes, and you will see the mounts beside the windows when you tour. Debby in 2024 was that kind of storm for us: days of rain and flooded rivers rather than destructive wind on the beach.</p><p style="${S.p}">During one stronger storm, one of our owners boarded up his house and took his family to sleep at the office for the night, because the building is newer commercial construction and he trusted it more than his house. That is the posture here: calm and specific. Water, fuel, the shutters down, and a decision made early about staying or going.</p><p style="${S.pLast}">One rule sits above every personal choice in this section: when the county orders an evacuation for your zone, you go. That is what the lettered zones below are for, and the county announces orders zone by zone on its own channels. What we do is our experience, not safety instruction; the county&#39;s emergency division decides.</p></div></section>
