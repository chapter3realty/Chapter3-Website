...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The off season</p><h2 style="${S.h2}">What Myrtle Beach is like in the winter</h2><p style="${S.pLast}">Quieter, and less different than the reputation suggests. The water parks and some attractions close and some places trim their hours, but the town keeps running. Restaurants, shops and the boardwalk stay open. The practical effect is that from about October to April everything is easier to get into, and several of our clients say the off season is the reason they stayed.</p></div></section>
