...
const faq = [
  ...
  { q: 'Will my property taxes go down if I move from North Carolina to South Carolina?',
    a: 'Somewhat. Charlotte and Raleigh run about 0.69 percent effective while Horry County runs about 0.38 percent on a primary home, and the primary rate also removes the school operating tax. Expect a saving of a few thousand a year on a comparable house, not a windfall.' },
  ...
  { q: 'How much do homes cost in Myrtle Beach compared with Charlotte or Raleigh?',
    a: 'A typical home here runs about $342,000, against about $389,000 in the Charlotte area and about $437,000 in the Raleigh area, on the same July 2026 measure.' },
  { q: 'Why do so many people move from North Carolina to Myrtle Beach?',
    a: 'North Carolina is the largest group we work with. The usual reasons are the coast itself, more house for the money than the Charlotte or Raleigh metros, and retirement deductions North Carolina does not offer. The bills are close. The coast is the difference.' },
];
...
<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">Income tax</p><h2 style="${S.h2}">The income tax can move either way, and the line sits near $100,000</h2><p style="${S.p}">North Carolina charges one flat rate on everything past its deduction. South Carolina charges a low rate on the first $30,000 and a higher one above it, with a deduction that shrinks as joint income climbs from $80,000 to $190,000.</p><p style="${S.p}">We ran the two published schedules side by side for a married couple with no dependents. At $60,000 of income, South Carolina charges about $600 and North Carolina about $1,400. At $100,000 the two states land within a few dollars of each other. Above $100,000, South Carolina charges more, not less.</p><p style="${S.pLast}">Dependents and credits move that line, so treat it as the shape of the comparison rather than your bill. What it means in practice: a working couple under $100,000 saves a little, a higher earner pays a little more, and nobody should make this move for the income tax alone.</p><div style="${S.ctaBox}"><p style="margin:0;color:var(--navy);font-family:var(--sans);font-size:.92rem;font-weight:600">Want the numbers on your own income and city?</p><div style="display:flex;gap:.7rem;flex-wrap:wrap"><a class="btn btn-brass" href="#lead-form">Run my income comparison</a><a class="btn btn-outline" href="tel:+18543332135">Call 854.333.2135</a></div></div></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">Pensions</p><h2 style="${S.h2}">Check which kind of pension you hold before you move</h2><p style="${S.p}">North Carolina fully exempts some older government pensions: state, local and federal retirees who had five years of service before August 12, 1989, and military retirees with twenty years of service. If that is you, this move taxes income that has been tax free. South Carolina exempts military retirement fully at any age, but other government pensions are ordinary retirement income here, sheltered only by the deductions.</p><p style="${S.pLast}">Every other retiree does better here. North Carolina taxes private pensions, 401(k)s and IRA withdrawals at the flat rate with no age break at all. South Carolina allows a retirement deduction of up to $3,000 before 65 and up to $10,000 from 65, plus a separate age-65 deduction of up to $15,000. Social Security is untaxed in both states.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The rest of the bill</p><h2 style="${S.h2}">Groceries, gas, property tax and the car</h2><h3 style="${S.h3}">Groceries and gas get cheaper</h3><p style="${S.p}">North Carolina puts a 2 percent local tax on groceries. Horry County puts none. Gas runs about 12.5 cents a gallon cheaper here on the two states&#39; published fuel taxes.</p><h3 style="${S.h3}">Property tax drops, but modestly</h3><p style="${S.p}">Charlotte and Raleigh both run about 0.69 percent effective. Horry County runs about 0.38 percent on a primary home, and the primary rate also removes the school operating tax. The gap is real money on the same house, but it is a few thousand a year, not the five figures a Northeast seller gives up. You apply for the primary rate yourself; the ${A('/buyers/property-taxes/', 'property tax page')} has the calculator and the deadline.</p><h3 style="${S.h3}">The car tax is familiar</h3><p style="${S.p}">North Carolina already taxes vehicles every year with the registration, so this one is not a surprise. The mechanics differ: here the county bills you first and the plate renews after you pay, a car titled elsewhere pays a one-time $250 fee at first registration, and you have 45 days from the move. The steps are on the ${A('/buyers/relocating/moving-checklist/', 'new resident checklist')}.</p><h3 style="${S.h3}">Sales tax goes up</h3><p style="${S.pLast}">General merchandise runs about 7.1 percent combined in North Carolina, against 8 percent in the county and 9 percent inside the City of Myrtle Beach.</p></div></section>
...
<h2 style="font-family:var(--serif);font-size:1.9rem;font-weight:300;color:var(--ivory);letter-spacing:-.01em;margin-bottom:.6rem;text-align:center">Tell us which part of Carolina you are leaving.</h2>
<p style="font-family:var(--sans);font-size:.93rem;color:rgba(244,239,232,.68);margin:0 auto 1.9rem;line-height:1.65;text-align:center;max-width:52ch">We will put your current bills next to the real ones on a house in your range here, and tell you what your sale actually buys on the Grand Strand.</p>
<div id="ldWrap">
<div style="display:grid;gap:.7rem;margin-bottom:1rem">
<input class="ld-in" id="ldCtx" placeholder="Where in North Carolina you are, and your price range here">
...
<button class="btn btn-brass" style="width:100%;justify-content:center" onclick="ldSubmit()">Compare my move</button>
...
function ldSubmit(){
 ...
 if(!cx||!n){fail('Add where you are moving from and your name.');return;}
 ...
 c3SendForm({property_address:cx,name:n,phone:ph,email:em,consent:c?'yes':'no'},'relocating-from-north-carolina');
 document.getElementById('ldWrap').style.display='none';
 document.getElementById('ldOk').style.display='block';
}
</script></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">What the sale buys</p><h2 style="${S.h2}">What a Charlotte or Raleigh sale buys at the coast</h2><p style="${S.p}">A typical Charlotte home sells for about $389,000 and a typical Raleigh home about $437,000, against about $342,000 here. That is not the gulf a New York seller sees, but it usually trades a suburban lot for a coastal one with money left over, and the property tax on it drops at the same time.</p><p style="${S.pLast}">Because the bills are this close, most North Carolina moves are really about the coast itself. That part is yours to judge. Our job is the numbers, and the ${A('/buyers/relocating/cost-of-living/', 'cost of living calculator')} runs them for your exact city in about a minute.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">One recent move</p><h2 style="${S.h2}">A North Carolina family who built here instead of buying</h2><p style="${S.p}">One of our recent North Carolina clients decided not to buy an existing house at all. They wanted out of North Carolina&#39;s taxes, a warmer coast, and a home built to their own plan, without ending up too far from family. We found the land, helped them vet a builder, and connected them with BrickWood Mortgage, which financed the construction.</p><p style="${S.p}">They brought their cleaning business with them too, and being local let them pitch the big hotels here directly. Land, builder and construction loan is a harder transaction than a resale. It has more steps and more ways to stall, and it goes better when the agent and the lender already work together. That is the setup we run.</p><p style="${S.small}">Chapter 3 Realty has a business relationship with BrickWood Mortgage. The full RESPA Affiliated Business Arrangement disclosure is in the footer of this page and ${A('/buyers/programs/#afba', 'here')}. You are never required to use BrickWood, and you are free to shop lenders.</p></div></section>
