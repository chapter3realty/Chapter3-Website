...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The short answer</p><h2 style="${S.h2}">Same ocean, five sets of rules</h2><p style="${S.p}">The Grand Strand&#39;s sand belongs to different governments: the cities of Myrtle Beach and North Myrtle Beach, the towns of Surfside Beach and Pawleys Island, and Horry County for the unincorporated stretches such as most of Garden City. Each writes its own beach rules, and they differ. Where you buy decides which government&#39;s rules apply on your everyday beach.</p><p style="${S.pLast}">Three rules are the same everywhere and worth stating once: no alcohol, no glass, no fires on the sand, anywhere. Everything else varies, and the two tables below carry the differences that change how you would use the beach: the dog clock and the shade rules. If one of these tables decides your town for you, the ${A('/buyers/relocating/which-town/', 'town by town page')} carries prices and the rest.</p></div></section>
