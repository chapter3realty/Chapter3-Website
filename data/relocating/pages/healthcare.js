...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">Where you buy</p><h2 style="${S.h2}">The area you choose changes the drive</h2><p style="${S.p}">The hospitals are spread from Georgetown in the south to Little River in the north, with Conway inland. An address in Carolina Forest, Socastee or the south strand sits near something being built rather than something finished, and both of those change between now and 2028.</p><p style="${S.pLast}">We will measure the drive from any specific address to whatever matters to you, before you make an offer. The ${A('/buyers/relocating/which-town/', 'town by town page')} sets out the other practical differences between the areas, and the ${A('/buyers/relocating/pros-and-cons/', 'pros and cons page')} covers what daily life here is actually like.</p></div></section>
