...
const faq = [
  { q: 'Is the cost of living cheaper in Myrtle Beach?',
    a: 'Yes. The biggest difference is the house. A typical home here sells for about $342,000, against about $737,000 in the New York area and about $742,000 in Boston. Day to day costs are closer to average, and rent is about 17 percent below the national average.' },
  ...
  { q: 'What costs more in Myrtle Beach than people expect?',
    a: 'Two things. South Carolina taxes your car every year, which most northern states do not, and that runs a few hundred dollars per vehicle. A second home or rental is taxed at about three times the rate of a main home.' },
  ...
  { q: 'Does the calculator include South Carolina taxes?',
    a: 'The cost of living calculator does not. The tax calculator further down this page does. Put in what you earn, how you earn it and what your house is worth. It shows the state income tax and the property tax you pay now next to what you would pay here. Car taxes are covered separately, because South Carolina charges one every year and most northern states do not.' },
];
...
function ldSubmit(){
 ...
 c3SendForm({name:n,phone:ph,consent:'yes'},'relocating-cost-of-living');
