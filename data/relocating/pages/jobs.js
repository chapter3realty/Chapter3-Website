...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The third option</p><h2 style="${S.h2}">Working remotely from here</h2><p style="${S.p}">Everything above assumes you will earn at local wages. Some of our buyers do not: they keep the job they have and bring it with them, which turns the wage gap on this page into an advantage, because a northern salary spends against Myrtle Beach prices. One of our clients works his New York job from here in alternating weeks; his story is further down this page, and the ${A('/buyers/relocating/getting-around/', 'getting around page')} covers the airport that makes it workable.</p><p style="${S.pLast}">The practical question is the wiring. Two wired providers cover most addresses here: HTC, the local cooperative, which says it runs the largest fiber network in the area and sells symmetrical speeds, and Spectrum, whose cable reaches most of the county with fast downloads and much slower uploads, the number video calls care about. Which one serves a given house changes street by street, not town by town, so check any address you are serious about on the ${X('https://broadbandmap.fcc.gov/', 'FCC broadband map')}, and tell us if remote work is your income: we check the wiring the way we check the flood zone.</p></div></section>
