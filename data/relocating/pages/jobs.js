...
const spec = {
  ...
  title: 'Jobs in Myrtle Beach, SC: What the Economy Pays',
  description: 'What work exists in Myrtle Beach, who the largest employers are, what the average job pays against the national average, and how seasonal the year is.',
...
<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The season</p><h2 style="${S.h2}">How the season moves the job market here</h2><p style="${S.p}">Because a quarter of the jobs follow the tourist season, unemployment here swings on a schedule. In January 2026 the county rate was 7.0 percent. In April 2026 it was 4.2 percent. In June 2026 it was 4.7 percent, still preliminary. Those are the same county in the same year.</p><p style="${S.p}">The shape repeats: the rate peaks in January and February, bottoms out in April, and rises again in late summer.</p><p style="${S.pLast}">The season changes things for two groups: hourly workers in hospitality, and anyone self-employed in a trade that serves visitors. Both should look at a full year of income rather than a good month before deciding what house payment they are comfortable with. Salaried work in the hospitals, the schools and the county does not move with the season at all.</p></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The third option</p><h2 style="${S.h2}">Working remotely from here</h2><p style="${S.p}">Everything above assumes you will earn at local wages. About half of the buyers who come to us from the northern states now arrive with a remote job. They keep the job they have and bring it with them. If you hold northern pay and live here, you are earning at the higher end of wages in this market. One of our clients works his New York job from here in alternating weeks; his story is further down this page, and the ${A('/buyers/relocating/getting-around/', 'getting around page')} covers the airport that makes it workable.</p><p style="${S.pLast}">The practical question is the wiring. Two wired providers cover most addresses here. HTC, the local cooperative, says it runs the largest fiber network in the area and sells symmetrical speeds. Spectrum&#39;s cable reaches most of the county with fast downloads and much slower uploads, and upload speed is the number that matters for video calls. Satellite service, including Starlink, reaches the addresses the wires miss, and the area has been in a fiber building push for several years. Cell service has not been a problem for our team on any of several carriers, and Devin&#39;s phone held through Tropical Storm Debby. Which provider serves a given house still changes street by street rather than town by town. Check any address you are serious about on the ${X('https://broadbandmap.fcc.gov/', 'FCC broadband map')}. Tell us if remote work is your income: we check the wiring the way we check the flood zone.</p></div></section>
