...
<p style="${S.p};margin-top:1.1rem">Two things follow from that list. If you work in health care, education or the trades, the hiring here is steady and the wage gap against the rest of the country is at its narrowest: education and health services pay $1,244 a week here against $1,278 nationally. If you are a senior manager in a corporate function, there are very few chairs, because there is no headquarters to sit in.</p><p style="${S.pLast}">There is manufacturing, but not much of it. The regional development corporation lists Kyocera AVX as the largest industrial employer at about 1,000 people, then Apollo Valves, Canfor Southern Pine, Pepsi Bottling Ventures and Metglas. Health care is the sector adding capacity fastest, because three hospitals are being built at once, which is covered on the ${A('/buyers/relocating/healthcare/', 'healthcare page')}.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The season</p><h2 style="${S.h2}">Unemployment swings 2.8 points between winter and spring</h2><p style="${S.p}">Because a quarter of the jobs follow the tourist season, unemployment here swings on a schedule. In January 2026 the county rate was 7.0 percent. In April 2026 it was 4.2 percent. In June 2026 it was 4.7 percent, still preliminary. Those are the same county in the same year.</p><p style="${S.p}">The shape repeats: the rate peaks in January and February, bottoms out in April, and rises again in late summer. Anyone quoting you one month without saying which month is telling you very little.</p><p style="${S.pLast}">Who this actually changes things for: hourly workers in hospitality, and anyone self-employed in a trade that serves visitors. Both should look at a full year of income rather than a good month before deciding what house payment they are comfortable with. Salaried work in the hospitals, the schools and the county does not move with the season at all.</p></div></section>
...
<h2 style="font-family:var(--serif);font-size:1.9rem;font-weight:300;color:var(--ivory);letter-spacing:-.01em;margin-bottom:.6rem;text-align:center">Tell us what you do, and what you need to earn.</h2>
<p style="font-family:var(--sans);font-size:.93rem;color:rgba(244,239,232,.68);margin:0 auto 1.9rem;line-height:1.65;text-align:center;max-width:52ch">We will tell you what that buys here, what the bills on it actually run, and put you in front of people hiring in your field if you want that.</p>
<div id="ldWrap">
<div style="display:grid;gap:.7rem;margin-bottom:1rem">
<input class="ld-in" id="ldCtx" placeholder="Your line of work, and the price range you are looking at">
...
<button class="btn btn-brass" style="width:100%;justify-content:center" onclick="ldSubmit()">Send my situation</button>
