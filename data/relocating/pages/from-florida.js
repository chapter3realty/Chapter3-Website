...
const faq = [
  { q: 'Why do people move from Florida to Myrtle Beach?',
    a: 'Four reasons repeat in the national data and reporting: the insurance renewal, condo assessments under Florida&#39;s post-Surfside inspection rules, and day-to-day costs that grew larger than the income-tax savings. The fourth is wanting to be closer to family up north without giving up a mild winter. Home prices matter too: a typical home here cost about $342,000 in July 2026 against about $378,000 statewide there. It is usually not taxes, and the tax section on this page says so plainly.' },
  ...
  { q: 'Is Myrtle Beach cheaper than Florida overall?',
    a: 'On average, yes. The price data behind our cost of living page puts the Myrtle Beach area about nine index points below the Florida statewide average. Housing is the widest gap: a typical home costs about $342,000 here against about $378,000 statewide in Florida. Groceries and gas cost less here, and home insurance averages about $4,500 a year against about $6,500 across Florida. One category is higher: state income tax, which Florida does not charge. For most Florida households the house and the insurance outweigh the income tax, and the calculator on this page runs your own numbers.' },
  ...
  { q: 'Is homeowners insurance cheaper in Myrtle Beach than in Florida?',
    a: 'On average, yes. Priced on the same $300,000 house, a Myrtle Beach policy averages about $4,500 a year against about $6,500 across Florida, about $15,600 in Miami, about $10,400 in Naples and about $6,300 in Tampa. Premiums are set per address, so buy through us and we get you written wind, hail and flood quotes on the exact house before you make an offer.' },
  { q: 'Will my car cost more to own in South Carolina than in Florida?',
    a: 'The tax on it, yes. Florida registration is a flat fee set by the car&#39;s weight. South Carolina bills every vehicle yearly on its value, roughly $360 to $460 on a $30,000 car plus a $50 road fee. Each vehicle also pays a one-time $250 fee at its first registration here, due within 45 days of the move.' },
];
