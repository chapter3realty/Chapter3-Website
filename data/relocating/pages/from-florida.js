...
const faq = [
  ...
  { q: 'Is Myrtle Beach cheaper than Florida overall?',
    a: 'On the house and the daily bills, usually. The price data behind our cost of living page puts the Myrtle Beach area roughly nine index points below the Florida statewide average, with housing the widest gap, and groceries and gas cost less here too. Taxes are usually higher here for a Florida household, so the honest total depends on your own numbers, and the calculator on this page runs them.' },
  ...
  { q: 'Is homeowners insurance cheaper in Myrtle Beach than in Florida?',
    a: 'We will not promise that. Insurance on this coast is priced per address: distance to water, elevation, roof age and flood zone. Get a written quote on any specific house here before you offer, wind and flood both, and put it beside your current Florida bill. That comparison is your answer.' },
