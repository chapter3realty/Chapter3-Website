...
const faq = [
  { q: 'Why do people move from Florida to Myrtle Beach?',
    a: 'The house money and the town. A typical home here ran about $342,000 in July 2026 against about $378,000 statewide in Florida, and far less than most of Florida&#39;s coastal metros. Day-to-day prices run below the Florida average, the beach towns are smaller, family in the Carolinas gets closer, and autumn is a real season. It is usually not taxes: most Florida movers pay somewhat more tax here, and the tax section on this page itemizes it.' },
  { q: 'Is Myrtle Beach cheaper than Florida overall?',
    a: 'On the house and the daily bills, usually. The price data behind our cost of living page puts the Myrtle Beach area roughly nine index points below the Florida statewide average, with housing the widest gap, and groceries and gas run lower here too. Taxes move the other way for most Florida households, so the honest total depends on your own numbers, and the calculator on this page runs them.' },
...
const spec = {
  ...
  description: 'What Florida movers gain in Myrtle Beach: a lower cost house on the coast, a smaller beach town that keeps its hospitals and flights, and honest numbers on the rest.',
...
<div class="detail-hero bg-grid"><div class="wrap"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/buyers/">Buyers</a><span>/</span><a href="/buyers/relocating/">Relocating</a><span>/</span><span style="color:var(--muted)">From Florida</span></div><p class="eyebrow" style="margin-bottom:1rem">Florida to the Grand Strand</p><h1 class="detail-h1">Moving from Florida<br/><em style="font-style:italic;color:var(--brass)">to Myrtle Beach.</em></h1><p style="color:var(--muted);font-size:.9rem;margin-bottom:1rem">By <strong style="color:var(--navy);font-weight:600">Devin Day</strong>, Operations Officer &amp; licensed MLO, NMLS 2721275 &middot; Reviewed by <strong style="color:var(--navy);font-weight:600">Timmy Fredrick Nash</strong>, Broker-in-Charge &middot; <span style="white-space:nowrap">Updated ${bylineDate}</span></p><p class="detail-sub">What to expect from the housing money, what to expect from a smaller beach town, what to expect on daily costs, and what to expect on insurance and taxes.</p><div style="margin-top:1.8rem;display:flex;gap:.75rem;flex-wrap:wrap"><a class="btn btn-brass btn-lg" href="#lead-form">Talk to a local expert</a><a class="btn btn-outline btn-lg" href="tel:+18543332135">Call 854.333.2135</a></div></div></div>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The short answer</p><h2 style="${S.h2}">What Florida movers gain here</h2><p style="${S.p}">You stay on the coast and most of the bills shrink. The typical home here ran about $342,000 in July 2026 against about $378,000 statewide in Florida, and far below most of Florida&#39;s coastal metros. Day-to-day prices run roughly nine index points under the Florida average, with housing the widest gap. The towns are smaller, and the necessities did not leave: an airport with ten airlines and more than 50 nonstop destinations, six hospitals including an adult Level I trauma center, and golf on the scale the area is known for, around 80 courses by the local count.</p><p style="${S.pLast}">Two things this page will not do. It will not pretend the tax table is a reason to come, because for most Florida movers it is not: taxes here run somewhat higher, and the ${A('#taxes', 'tax section')} itemizes every line. And it will not promise your insurance falls, because that is decided per address, not per state. Everything else is below, in the order it actually matters.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The biggest number</p><h2 style="${S.h2}">What a Florida sale buys at the coast</h2><p style="${S.p}">The typical Florida home ran about $378,000 in July 2026; the typical home here about $342,000. Averages understate the real spread, because Florida&#39;s coastal metros price far above their state line while the Grand Strand does not. A sale in most of coastal Florida buys a comparable house here with money left over, a smaller loan, or both. A sale in inland or Panhandle markets lands closer to even, and we will say so rather than stretch it.</p><p style="${S.pLast}">What the leftover money does is your call: a lower payment, a bigger house, or cash kept. Where it goes furthest differs by town, and several towns around Myrtle Beach are smaller and quieter than the name suggests. The ${A('/buyers/relocating/which-town/', 'which town page')} maps the differences before you book a trip.</p><div style="${S.ctaBox}"><p style="margin:0;color:var(--navy);font-family:var(--sans);font-size:.92rem;font-weight:600">Selling in Florida and buying here?</p><div style="display:flex;gap:.7rem;flex-wrap:wrap"><a class="btn btn-brass" href="#lead-form">Start with a real comparison</a><a class="btn btn-outline" href="tel:+18543332135">Call 854.333.2135</a></div></div></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The town</p><h2 style="${S.h2}">A smaller beach town that keeps the hospitals and the airport</h2><p style="${S.p}">If what you want is a smaller town that still works, that is this market&#39;s exact shape. Myrtle Beach in a search box covers a run of separate towns, and several are far quieter than the name: Surfside Beach, Pawleys Island, Litchfield, Little River, Murrells Inlet. Each keeps its own pace and price range, and plenty of buyers who arrive searching Myrtle Beach buy in one of them.</p><p style="${S.p}">The infrastructure a Floridian is used to stayed. The airport runs ten airlines with more than 50 nonstop destinations, so getting back to Florida for family is one flight, and ${A('/buyers/relocating/getting-around/', 'getting around')} covers the roads from there. Six hospitals serve the area, led by an adult Level I trauma center, with three more under construction; the ${A('/buyers/relocating/healthcare/', 'healthcare page')} lists each with beds and addresses. Golf is on the scale the area is known for, around 80 courses by the local count.</p><p style="${S.pLast}">The beach itself gains a winter season most Floridians have not had: on the county&#39;s unincorporated beaches you can drive a golf cart on the sand from November 1 through February 28, and the ${A('/buyers/relocating/beaches/', 'beach rules page')} has the dog hours and umbrella rules town by town. Summer stays a real beach summer. The other end of the year changes more: autumn shows up as a season, and winter runs cooler than Florida&#39;s, cool enough for a jacket. The ${A('/buyers/relocating/weather/', 'weather page')} has the season by season numbers, including the ocean temperature month by month.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">Daily costs</p><h2 style="${S.h2}">Groceries, gas and the power bill</h2><p style="${S.p}">The everyday lines mostly run lower. Groceries cost less here than the Florida average and are untaxed in both states. The gas tax is about 11 cents a gallon lower, on top of the price difference at the pump. The typical electric bill runs a few dollars a month lower. These come from the same price data behind our ${A('/buyers/relocating/cost-of-living/', 'cost of living calculator')}, which compares your own metro, not just the state line, against the Grand Strand.</p><p style="${S.pLast}">One register line moves the other way and we will not hide it: the general sales tax is 8 percent in unincorporated Horry County and 9 percent in the City of Myrtle Beach, against roughly 7 percent average combined in Florida.</p></div></section>
...
<section style="background:var(--ivory-2)" id="taxes"><div class="wrap"><p style="${S.eyebrow}">Full disclosure</p><h2 style="${S.h2}">The taxes, honestly</h2><p style="${S.p}">This is the one page in our state series where the tax table mostly moves against the mover, and we would rather show that than bury it. Every line, both directions:</p>
...
<h3 style="${S.h3}">Income</h3><p style="${S.p}">You pick up an income tax. A working couple on $120,000 of wages pays about $3,700 a year here that Florida never charged. Retirees fare better: Social Security stays untaxed, and the deductions from 65, up to $10,000 of retirement income plus an age deduction of up to $15,000 per person plus the standard deduction, typically leave a couple drawing $60,000 of pension and $30,000 of Social Security owing nothing. A couple drawing six figures from IRAs will owe real money. Military retirement is fully exempt at any age.</p>
<h3 style="${S.h3}">The house</h3><p style="${S.p}">The property tax falls: roughly $1,390 a year on a $378,000 primary home in unincorporated Horry County against about $2,900 at Florida&#39;s average rate on a new purchase. One honest caveat for long-time owners: your current Florida bill is probably held down by the cap on assessed value, and that protection ends when you sell no matter where you go next, so compare your actual bill, not the average. The cap&#39;s benefit can move to another Florida homestead but not across the state line. At 65 and older, after a year of residency here, a homestead exemption takes the first $50,000 of value off the bill. The ${A('/buyers/property-taxes/', 'property tax page')} has the calculator and the application deadline.</p>
<h3 style="${S.h3}">The car, the estate, the leaving</h3><p style="${S.p}">The car tax is the one new bill: South Carolina taxes every vehicle yearly on its value, roughly $360 to $460 on a $30,000 car plus a $50 road fee, with a one-time $250 fee per vehicle and a 45 day registration window; steps are on the ${A('/buyers/relocating/moving-checklist/', 'new resident checklist')}. Neither state taxes estates or inheritances, so nothing in your estate plan is forced to move. And Florida charges nothing for leaving.</p>
...
${taxCalcSection({ preselect: 'FL', bg: 'ivory' })}
