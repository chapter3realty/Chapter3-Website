...
const faq = [
  ...
  { q: 'Is there public transportation in Myrtle Beach?',
    a: 'Coast RTA runs fixed bus routes seven days a week, 362 days a year, serving Myrtle Beach, Conway, Surfside Beach, Garden City, Murrells Inlet, Pawleys Island, Georgetown, Loris and more. Fares are about a dollar a ride; check the current table on their site. Every bus is wheelchair accessible.' },
...
const spec = {
  ...
  title: 'Getting Around Myrtle Beach: Airport, Roads, Transit',
...
<div class="detail-hero bg-grid"><div class="wrap"><div class="breadcrumb"><a href="/">Home</a><span>/</span><a href="/buyers/">Buyers</a><span>/</span><a href="/buyers/relocating/">Relocating</a><span>/</span><span style="color:var(--muted)">Getting Around</span></div><p class="eyebrow" style="margin-bottom:1rem">Planes, roads and the bus</p><h1 class="detail-h1">Getting around<br/><em style="font-style:italic;color:var(--brass)">Myrtle Beach.</em></h1><p style="color:var(--muted);font-size:.9rem;margin-bottom:1rem">By <strong style="color:var(--navy);font-weight:600">Devin Day</strong>, Operations Officer &amp; licensed MLO, NMLS 2721275 &middot; Reviewed by <strong style="color:var(--navy);font-weight:600">Timmy Fredrick Nash</strong>, Broker-in-Charge &middot; <span style="white-space:nowrap">Updated ${bylineDate}</span></p><p class="detail-sub">An airport inside the city with nonstops to more than 50 places, two freeways behind the beach, a thin but real bus system, and no interstate yet. The specifics, sourced.</p><div style="margin-top:1.8rem;display:flex;gap:.75rem;flex-wrap:wrap"><a class="btn btn-brass btn-lg" href="#lead-form">Ask about my commute</a><a class="btn btn-outline btn-lg" href="tel:+18543332135">Call 854.333.2135</a></div></div></div>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The airport</p><h2 style="${S.h2}">The airport is in town, and the family can fly straight here</h2><p style="${S.p}">Myrtle Beach International sits inside the city, minutes from most of the Grand Strand rather than an hour out. As of August 2026 it lists ten airlines and nonstop service to more than 50 cities, and the airline list changes several times a year, so check the current ${X('https://www.flymyrtlebeach.com/flight-information/route-map/', 'route map')} for your own city. In 2024, the last full year the airport has published, it handled 3,837,052 passengers, its record. A terminal expansion opened in December 2025, and the airport reported top national rankings in USA Today&#39;s 10Best readers&#39; choice awards in October 2025.</p><p style="${S.pLast}">For a relocator this matters in both directions: you can get back to where you came from without a connection, and the people you left can get to you. One of our clients works his New York job in alternating weeks from here, which the ${A('/buyers/relocating/jobs/', 'jobs page')} covers. Honesty note: Spirit stopped flying everywhere in May 2026, and it had been a large carrier here, so this year&#39;s passenger count will look different from 2024&#39;s record.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The roads</p><h2 style="${S.h2}">Two US 17s and two freeways: learn these four names first</h2><h3 style="${S.h3}">US 17 Business is Kings Highway</h3><p style="${S.p}">The old road, closest to the ocean, running through the beachfront strip with stoplights and driveways. Slowest, most scenic, most tourist traffic.</p><h3 style="${S.h3}">US 17 Bypass is the workhorse</h3><p style="${S.p}">The divided highway just inland. Its busiest stretch, between SC 707 and US 501, counted 82,200 vehicles a day in 2025, the highest figure in the county.</p><h3 style="${S.h3}">SC 31 and SC 22 are the roads locals use</h3><p style="${S.p}">Two limited access freeways further inland, built under the county&#39;s road sales tax. SC 31 runs behind the beach from Little River to Socastee; SC 22 connects the Conway area to the north strand. Almost no stoplights on either. The county&#39;s own planning document says many returning tourists avoid or are unaware of these roads, which is exactly why a ten mile drive on them beats the same ten miles on the beach highway, measured on the ${A('/buyers/relocating/which-town/', 'town by town page')}.</p><h3 style="${S.h3}">US 501 is the road inland</h3><p style="${S.pLast}">The main artery to Conway and onward toward I-95. A surface road with lights, not a freeway, and it carries up to 65,900 vehicles a day near the beach. If your life will run between Conway and the coast daily, drive your exact commute once before you offer on a house.</p></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The interstate</p><h2 style="${S.h2}">There is no interstate to Myrtle Beach, and here is the honest status of I-73</h2><p style="${S.p}">Myrtle Beach is one of the largest US metros with no interstate connection, and the planned fix is I-73, which would link the coast to I-95. As of 2026 the truthful status is this: no segment is open, no segment is under construction, and no construction contract has been signed. The state has bought about 99 percent of the right of way between I-95 and US 501 and most of the next stretch, and the county has set aside 450 million dollars of conditional matching money that only unlocks when the state signs construction contracts. Nobody can tell you an opening date, and this page will not invent one.</p><p style="${S.pLast}">Separately, the two Carolinas are studying an extension of SC 31 north across the state line to US 17 near Shallotte. Hearings were held in autumn 2025; construction, if it happens, was reported as unlikely to begin before 2029. Until either project moves, the practical routes to the wider world are US 501 to I-95, and US 17 along the coast.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The bus, honestly</p><h2 style="${S.h2}">Coast RTA exists and is thin: plan on a car</h2><p style="${S.p}">The public bus, Coast RTA, runs fixed routes seven days a week, 362 days a year, reaching Myrtle Beach, Conway, Surfside Beach, Garden City, Murrells Inlet, Pawleys Island, Georgetown, Loris and more. Every bus is wheelchair accessible. The fare is about a dollar a ride with a daily cap when you tap a card; the operator&#39;s posted tables vary, so check the current fare on their site before you rely on it.</p><p style="${S.pLast}">What it is not is a system you can build a commute around in most of the county. Frequencies are low and coverage is a skeleton. Households here run on cars, and many neighborhoods add a golf cart for local streets, which takes a five dollar permit covered on the ${A('/buyers/relocating/moving-checklist/', 'new resident checklist')}.</p></div></section>
...
<div style="${S.ctaBox}"><p style="margin:0;color:var(--navy);font-family:var(--sans);font-size:.92rem;font-weight:600">Want your commute measured before you offer on a house?</p><div style="display:flex;gap:.7rem;flex-wrap:wrap"><a class="btn btn-brass" href="#lead-form">Ask about my commute</a><a class="btn btn-outline" href="tel:+18543332135">Call 854.333.2135</a></div></div></div></section>
