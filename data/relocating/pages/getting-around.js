...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The airport</p><h2 style="${S.h2}">The airport is in town, and the family can fly straight here</h2><p style="${S.p}">Myrtle Beach International sits inside the city, minutes from most of the Grand Strand rather than an hour out. As of August 2026 it lists ten airlines and nonstop service to more than 50 cities, and the airline list changes several times a year, so check the current ${X('https://www.flymyrtlebeach.com/flight-information/route-map/', 'route map')} for your own city. In 2024, the last full year the airport has published, it handled 3,837,052 passengers, its record. A terminal expansion opened in December 2025, and the airport reported top national rankings in USA Today&#39;s 10Best readers&#39; choice awards in October 2025.</p><p style="${S.p}">For a relocator this matters in both directions: you can get back to where you came from without a connection, and the people you left can get to you. One of our clients works his New York job in alternating weeks from here, which the ${A('/buyers/relocating/jobs/', 'jobs page')} covers. Honesty note: Spirit stopped flying everywhere in May 2026, and it had been a large carrier here, so this year&#39;s passenger count will look different from 2024&#39;s record.</p><p style="${S.pLast}">How we use it, from Devin, who wrote this page. With no checked bag he has walked in an hour before a flight and made it; with real luggage, plan on two and a half hours, because in his experience bag check closes out well before departure and same day ticket sales stop roughly two hours out. He usually flies Allegiant, whose own fee schedule lists a $22 per passenger, per segment charge on bookings made on the website or call center; buy at the airport counter instead and that charge does not apply, and the counter is staffed around departures, which is workable once you live here. Some of our clients hold Frontier&#39;s ${X('https://www.flyfrontier.com/deals/gowild-pass/', 'GoWild all you can fly pass')}: as of August 2026 Frontier&#39;s nonstops from here are Cleveland and Long Island, and the pass also books connecting routes.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The roads</p><h2 style="${S.h2}">Two US 17s and two freeways: learn these four names first</h2><h3 style="${S.h3}">US 17 Business is Kings Highway</h3><p style="${S.p}">The old road, closest to the ocean, running through the beachfront strip with stoplights and driveways. Slowest, most scenic, most tourist traffic.</p><h3 style="${S.h3}">US 17 Bypass is the workhorse</h3><p style="${S.p}">The divided highway just inland. Its busiest stretch, between SC 707 and US 501, counted 82,200 vehicles a day in 2025, the highest figure in the county.</p><h3 style="${S.h3}">SC 31 and SC 22 are the roads locals use</h3><p style="${S.p}">Two limited access freeways further inland, built under the county&#39;s road sales tax. SC 31 runs behind the beach from Little River to Socastee; SC 22 connects the Conway area to the north strand. Almost no stoplights on either. The county&#39;s own planning document says many returning tourists avoid or are unaware of these roads, which is exactly why a ten mile drive on them beats the same ten miles on the beach highway, measured on the ${A('/buyers/relocating/which-town/', 'town by town page')}.</p><h3 style="${S.h3}">US 501 is the road inland</h3><p style="${S.p}">The main artery to Conway and onward toward I-95. A surface road with lights, not a freeway, and it carries up to 65,900 vehicles a day near the beach. If your life will run between Conway and the coast daily, drive your exact commute once before you offer on a house.</p><p style="${S.pLast}">One concrete commute, Devin&#39;s: US 17 from Murrells Inlet to Surfside Beach at 7 a.m. is wide open, the run up to Carolina Forest near 5 p.m. is a little busy, and the only place he reliably waits is the traffic lights entering and leaving Carolina Forest. In three years of daily driving he has yet to sit in traffic on SC 31.</p></div></section>
