...
const faq = [
  ...
  { q: 'Does South Carolina tax my car every year?',
...
const spec = {
  ...
  title: 'Moving From Ohio to Myrtle Beach: What Changes',
...
<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">Income tax</p><h2 style="${S.h2}">You stop paying city income tax</h2><p style="${S.p}">Ohio&#39;s state rate is one of the lowest in the country. The bill most Ohio households notice is the layer under it: city income taxes, commonly 1 to 3 percent of wages, and in some places a school district income tax on top of that.</p><p style="${S.pLast}">South Carolina has no local income tax anywhere. No city rate, no district rate. For a working household this is the largest single income-tax change in the whole comparison, and it is bigger than the difference between the two state rates.</p></div></section>
