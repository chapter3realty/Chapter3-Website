...
const faq = [
  ...
  { q: 'What surprised Devin most after moving from Ohio?',
    a: 'The vehicle tax bill, first. Then two he did not see coming: needing sunglasses daily in summer, and a job market that read like a much bigger city&#39;s than the small Ohio town he left.' },
];
...
<button class="btn btn-brass" style="width:100%;justify-content:center" onclick="ldSubmit()">Ask Devin</button>
...
<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">First hand</p><h2 style="${S.h2}">What surprised Devin after the move</h2><p style="${S.p}">Three years in, three things stand out to him. The vehicle tax bill, which Ohio never sends. Needing sunglasses: he never owned a pair that mattered in Ohio and reaches for them daily here in summer. And the job market: coming from a small Ohio town, the range of work here read like a much bigger city&#39;s.</p><p style="${S.pLast}">His own bills are quoted, labelled as one household&#39;s, on the ${A('/buyers/relocating/cost-of-living/', 'cost of living page')}, and his first-45-days mistakes are the reason the ${A('/buyers/relocating/moving-checklist/', 'checklist')} exists.</p></div></section>
