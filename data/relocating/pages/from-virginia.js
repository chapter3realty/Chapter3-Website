...
const faq = [
  ...
  { q: 'Will I still pay an annual car tax in South Carolina?',
    a: 'Yes, and you already know the routine. Every vehicle is taxed on its value each year and the county bill is paid before the plate renews. A $30,000 car runs about $362 a year in unincorporated Horry County plus a $50 road fee, and a car titled elsewhere pays a one-time $250 fee at first registration.' },
  { q: 'How much does a house cost in Myrtle Beach compared with Virginia?',
    a: 'A typical home here runs about $342,000 against a Virginia statewide average of about $418,000, on the same July 2026 Zillow measure. The statewide number hides the split between Northern Virginia and everywhere else, so run your own city through our cost of living calculator.' },
...
const spec = {
  ...
  description: 'Virginia to Myrtle Beach for a mover: the car tax you already know, the age deduction against the deductions here, military retirement, and what a sale buys.',
