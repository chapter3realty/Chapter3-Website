...
const faq = [
  { q: 'How much lower are property taxes in Myrtle Beach than New Jersey?',
    a: 'Bergen County averages about 1.89 percent effective; Horry County averages about 0.38 percent on a primary home, and the primary rate removes the school operating tax. At published rates a $400,000 primary home in the unincorporated county bills roughly $1,470 a year. Seniors should first net off New Jersey&#39;s relief programs, which do not travel.' },
  { q: 'Is there a New Jersey exit tax when you sell your house?',
...
function ldSubmit(){
 ...
 c3SendForm({name:n,phone:ph,consent:'yes'},'relocating-from-new-jersey');
