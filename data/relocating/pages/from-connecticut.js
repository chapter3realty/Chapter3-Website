...
const faq = [
  ...
  { q: 'How much does a house cost in Myrtle Beach compared with Connecticut?',
    a: 'A typical home here runs about $342,000 against a Connecticut statewide average of about $453,000, on the same July 2026 Zillow measure. Fairfield County sits far above that average and the northeast corner below it, so run your own town through our cost of living calculator.' },
];
...
const spec = {
  ...
  description: 'Connecticut to Myrtle Beach: the property tax cut in half or better, the income lines Connecticut draws on retirement, the smaller car bill, and home prices.',
...
<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The headline</p><h2 style="${S.h2}">The property tax falls by more than half</h2><p style="${S.p}">Connecticut&#39;s effective property tax rate of about 1.54 percent is among the highest in the country, and the median bill is $6,573. Horry County&#39;s primary-home rate works out near 0.38 percent, the median South Carolina bill is $1,337, and the primary rate also removes the school operating tax from your bill entirely.</p><p style="${S.p}">Put real numbers on it: a $450,000 Connecticut house near the state average carries a bill most owners here would associate with a house three times the price. Buy a $342,000 home here as your primary residence and the bill lands near a tenth of many Fairfield County bills, and the savings repeat every year you own it.</p><p style="${S.pLast}">You apply for the primary rate yourself after you move, by May 31, or your first bill arrives at the higher 6 percent second-home rate. The ${A('/buyers/property-taxes/', 'property tax page')} has the calculator and the deadline, and the ${A('/buyers/relocating/moving-checklist/', 'new resident checklist')} puts it in order with the rest.</p><div style="${S.ctaBox}"><p style="margin:0;color:var(--navy);font-family:var(--sans);font-size:.92rem;font-weight:600">Want your Connecticut bills against a real house here?</p><div style="display:flex;gap:.7rem;flex-wrap:wrap"><a class="btn btn-brass" href="#lead-form">Run my property tax saving</a><a class="btn btn-outline" href="tel:+18543332135">Call 854.333.2135</a></div></div></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">Retirees</p><h2 style="${S.h2}">Connecticut draws income lines. South Carolina does not.</h2><p style="${S.p}">Connecticut has genuinely improved for retirees, and this page will not pretend otherwise. Below $75,000 of AGI for a single filer or $100,000 for a couple, Social Security is untaxed and pension and annuity income is fully exempt, and beginning with the 2026 tax year IRA withdrawals are fully exempt under the same lines, the last step of a phase-in that started in 2023.</p><p style="${S.p}">The catch is the lines themselves. Cross $75,000 or $100,000 and part of Social Security becomes taxable at once. The pension, annuity and IRA exemptions slide away between those thresholds and $100,000 single or $150,000 joint, where they reach zero. One good year, one large IRA withdrawal for a roof or a car, and the exemptions thin out exactly when the income arrives.</p><p style="${S.pLast}">South Carolina&#39;s version is smaller and simpler: Social Security untaxed at any income, a retirement deduction of up to $10,000 from 65 plus an age-65 deduction of up to $15,000 per person, and every dollar of military retirement exempt. No thresholds, no cliff, no year where the rules change because your income did. The ${A('/buyers/retirees/', 'retiree page')} covers what else changes.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The income tax</p><h2 style="${S.h2}">No standard deduction, and the recapture rule</h2><p style="${S.p}">Connecticut&#39;s rates run 2 to 6.99 percent, which looks ordinary next to South Carolina&#39;s 1.99 and 5.21. Two design choices make Connecticut&#39;s bill bigger than its brackets suggest. There is no standard deduction, only a personal exemption that itself phases out as income rises. And Connecticut applies benefit recapture: past certain income levels the lower brackets are clawed back, so a high earner pays the top rate on all income rather than just the top slice above the threshold.</p><p style="${S.pLast}">South Carolina starts a joint return with a $30,000 standard deduction, taxes the first $30,000 above it at 1.99 percent, and takes 5.21 percent of the rest, at every income, with nothing clawed back. For most households the difference is modest; for high earners the recapture rule makes it larger than the rate gap implies. Run your own number on the ${A('/buyers/relocating/cost-of-living/', 'cost of living calculator')}.</p></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">The car and the register</p><h2 style="${S.h2}">The car bill shrinks. The register takes more.</h2><h3 style="${S.h3}">The car tax you already know</h3><p style="${S.p}">You will not need the warning we give Ohio and Maryland movers, because Connecticut already taxes cars yearly: 70 percent of a depreciated value at the town mill rate, capped at 32.46 mills. Here the county taxes vehicles on value too, and the working numbers are these: about $362 a year on a $30,000 car in unincorporated Horry County, about $458 inside the City of Myrtle Beach, plus a $50 road fee, with a one-time $250 fee when a car titled elsewhere first registers. For most movers that is a smaller bill than the one they left. The steps and deadlines are on the ${A('/buyers/relocating/moving-checklist/', 'new resident checklist')}.</p><h3 style="${S.h3}">Sales tax rises</h3><p style="${S.pLast}">Connecticut charges 6.35 percent statewide. Here it is 8 percent in the county and 9 percent inside the City of Myrtle Beach, with groceries untaxed in Horry County. On most purchases you will pay more at the register, and we would rather this page tell you than the receipt.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">The estate, briefly</p><h2 style="${S.h2}">The only state gift tax, and it no longer matters much</h2><p style="${S.pLast}">Connecticut is the only state with its own gift tax, and it pairs with an estate tax at a flat 12 percent. Both now share one exemption that tracks the federal amount: $15 million for 2026. At that level the tax reaches almost nobody, so unlike Maryland or Massachusetts, the estate line is no longer a reason to leave Connecticut. We would rather tell you that plainly than sell you a benefit you would not receive. South Carolina, for the record, has no estate tax, no inheritance tax and no gift tax.</p></div></section>

<section style="background:var(--ivory)"><div class="wrap"><p style="${S.eyebrow}">What the sale buys</p><h2 style="${S.h2}">What a Connecticut sale buys at the coast</h2><p style="${S.p}">A typical Connecticut home runs about $453,000 on the statewide Zillow average, against about $342,000 here, on the same July 2026 measure. Fairfield County sits far above that average and the northeast corner below it, so run your own town through the ${A('/buyers/relocating/cost-of-living/', 'cost of living calculator')}. The property tax on whatever you buy drops from a $6,573 median bill to a $1,337 one, every year.</p><p style="${S.pLast}">If a boat is part of the plan, start where the water is: ${A('/submarkets/little-river/', 'Little River')} keeps the Intracoastal marinas and fishing docks, ${A('/submarkets/murrells-inlet/', 'Murrells Inlet')} works the saltwater creek behind the MarshWalk, and ${A('/submarkets/north-myrtle-beach/', 'North Myrtle Beach')} puts the waterway a golf cart ride from the sand. The ${A('/buyers/relocating/which-town/', 'town by town page')} compares all ten areas on price, rules and features.</p></div></section>

<section style="background:var(--ivory-2)"><div class="wrap"><p style="${S.eyebrow}">First hand</p><h2 style="${S.h2}">What Connecticut movers tell us, and the landing strip</h2><p style="${S.p}">Our Connecticut clients tend to praise what they are leaving, and they are right to: the historic towns, the schools, places that have been beautiful for three hundred years. What sends them south is the rest of it. The winters go on too long, prices they describe as getting out of hand, and they want more beach and more room than the shoreline they left.</p><p style="${S.pLast}">The room is real, and one example says it better than a statistic: we have friends here who bought acreage, built their own landing strip, and earned their pilot licenses. Most buyers want nothing that ambitious. The point is that land like that exists here, close to town, at prices that make it a decision rather than a fantasy. The acreage answer usually starts inland, around Longs and Conway, and the ${A('/buyers/relocating/which-town/', 'town by town page')} shows where.</p></div></section>
